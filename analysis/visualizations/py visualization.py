...
plt.close()
print("✅ Chart 1 saved: 1_stop_accessibility_pie.png")

# Chart 2: Bar Chart
# Chart 2: Bar Chart (with Fully, Partially, Inaccessible breakdown)
...
plt.close()
print("✅ Chart 2 saved: 2_route_accessibility_bar.png (with 3 categories)")
# Chart 3: Map
...
plt.close()
print("✅ Chart 3 saved: 3_accessibility_map.png")
...
plt.close()
print("✅ Chart 4 saved: 4_route_accessibility_summary.png")
...
plt.close()
print("✅ Chart 5 saved: 5_top_10_routes.png")

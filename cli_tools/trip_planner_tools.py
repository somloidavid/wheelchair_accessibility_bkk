...
def print_trip_plan(network):
    print('| ')
    print((f'{textwrap.fill('Trip planner is a tool to help users quickly plan an accessible route between point A and B', width = window_size - 3, initial_indent='| ',  subsequent_indent='| ' )}'))